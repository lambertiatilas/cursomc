...
import com.nelioalves.cursomc.security.AccessDeniedHandlerJwt;
import com.nelioalves.cursomc.security.AuthenticationEntryPointJwt;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.and().exceptionHandling().authenticationEntryPoint(authenticationEntryPointJwt).and()
